...
#! @Description
#!  This function returns true if the entered representation  <A>R</A>
#!  is a semisimple representation and false otherwise. 
#! @Returns <C>true</C> or <C>false</C>
#! @Arguments R
DeclareProperty( "IsSemisimpleRepresentation", IsQuiverRepresentation );

#!
InstallTrueMethod( IsSemisimpleRepresentation, IsSimpleRepresentation );
